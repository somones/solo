...
<div class="page-header">
  <div class="row">
    <div class="col-md-4 text-xs-center text-md-left text-nowrap">
      <h1><i class="page-header-icon ion-ios-pulse-strong"></i>Delete Job Request</h1>
    </div>
  </div>
</div>
				...
				<table class="table table-responsive table-bordered table-primary" name="data_grid">
					...
					<tbody>
						...
						<tr>							
							...
							<td><button type="button" class="btn btn-danger" onclick="submit_delete_request('<?php echo $request_obj[$i]["request_id"]; ?>')">Delete</button></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>
