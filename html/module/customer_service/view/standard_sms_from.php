		...
		$("#category").change(function(){
			...
			$.ajax({
				...
				templates.forEach(function(template){
					...
					console.log(template.message_template_description);
					$("#message_content").empty("");
					$("#templates option").bind("click",function() { 
						//var iid = template.message_template_id;
...
<div class="page-header">
    ...
    <div class="btn-group"><?php //print_r($_POST); ?></div>
</div>
<div>
	<div class="panel">
	    	...
	    	<form class="form-horizontal" method="post" action=""> 
			    <div class="form-group">
		      	...
		      	<div class="form-group">
		        	...
		        	<input type="text" class="form-control" id="receiver_number">
		      	</div>
		      	...
		      	<div class="form-group">
		        	<textarea class="form-control" id="message_content" rows="8" ng-model="message_content" onkeyup="charcountupdate(this.value)"></textarea>
