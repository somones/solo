...
{
	$meetingObj=new meeting($meeting_id);
	...
	$meeting_start=$meetingObj->meeting_start_date_time;
	$meeting_end=$meetingObj->meeting_end_date_time;
	$meeting_notes=$meetingObj->meeting_description;	
...
<div class="page-header">
    <div class="row">
        <div class="col-md-4 text-xs-center text-md-left text-nowrap">
          <h1><i class="page-header-icon ion-ios-pulse-strong"></i>Add/ Edit Meeting</h1>
        </div>
    </div>
</div>
<div class="row">
	  ...
	  <div class="panel-body">
	    <form class="form-horizontal" method="post" action=""> 
	      <div class="form-group">
	        ...
	        <div class="col-md-9">
	          <input type="text" class="form-control" id="meeting_title" value="<?php echo $meeting_title; ?>" placeholder="Title of Meeting">
	        </div>
	      </div>
		<div class="form-group">
			...
			<div class="col-md-9">
				<select class="form-control" id="meeting_room">
					<option value=""></option>
					<?php
					for($i=0;$i<count($av_rooms);$i++)
					{
						?>
						<option <?php if($av_rooms[$i]["room_id"] == $meeting_room) {  ?> selected="selected" <?php  } ?> value="<?php echo $av_rooms[$i]["room_id"]; ?>"><?php echo $av_rooms[$i]["room_title"]; ?></option>
						<?php
					}
					?>
				</select>
	    ...
	    <div class="form-group">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" value="<?php echo $meeting_start; ?>" name="date_time_value" id="meeting_start_date_time">
			</div>		
		</div>
		<div class="form-group">
			<label for="grid-input-1" class="col-md-3 control-label">End Date</label>
			<div class="col-md-9">
				<input type="text"  class="form-control" value="<?php echo $meeting_end; ?>" name="date_time_value" id="meeting_end_date_time">
			</div>		
		</div>
	    <div class="form-group">
		...
		<div class="form-group">
	        ...
	        <div class="col-md-9">
	         <textarea id="meeting_description" class="form-control" placeholder="Meeting Description"><?php echo $meeting_notes; ?></textarea>
	        </div>
	    </div>

	    <div class="form-group">
	        <div class="col-md-offset-3 col-md-9">
	          <button type="button" class="btn btn-primary" onclick="submit_save_meeting('<?php echo $meeting_id; ?>')">Save Meeting</button>
	        </div>
	   	</div>
	    </form>
	  </div>
